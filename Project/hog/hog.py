...
def swine_align(player_score, opponent_score):
    ...
    if (player_score == 0) or (opponent_score == 0):
        ...
        round = min(player_score, opponent_score)
        while round > 0:
            if (player_score % round == 0) and (opponent_score % round == 0):
                GCD = round
                if GCD >= 10:
                    return True
            round = round - 1
...
def pig_pass(player_score, opponent_score):
    ...
    return (score_diff > 0) and (score_diff < 3)
    # END PROBLEM 4b
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    # BEGIN PROBLEM 5
    "*** YOUR CODE HERE ***"
    game_continue = lambda score0, score1: (score0 < goal) and (score1 < goal)
    while game_continue(score0, score1):
        if who == 0:
            player0_num_rolls = strategy0(score0, score1)
            score0 = score0 + take_turn(player0_num_rolls, score1, dice)
            say = say(score0, score1)
            while extra_turn(score0, score1) and game_continue(score0, score1):
                player0_num_rolls = strategy0(score0, score1)
                score0 = score0 + take_turn(player0_num_rolls, score1, dice)
                say = say(score0, score1)
            who = other(who)
            ...
            say = say(score0, score1)
            while extra_turn(score1, score0) and game_continue(score0, score1):
                player1_num_rolls = strategy1(score1, score0)
                score1 = score1 + take_turn(player1_num_rolls, score0, dice)
                say = say(score0, score1)
            who = other(who)
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def annouce(score0, score1):
        ...
        if score_diff > running_high:
            local_running_high = score_diff
            print(score_diff,'point(s)! The most yet for Player', who)
        else:
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    best_times = 0
    while i < 10:
        average_score = averaged_dice(i+1, dice)
...
def final_strategy(score, opponent_score, cutoff=16, num_rolls=6):
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    if extra_turn(score+free_bacon(opponent_score), opponent_score):
        return 0
    if score > 80:
        return bacon_strategy(score, opponent_score, 8, num_rolls)
    else:
        return bacon_strategy(score, opponent_score, cutoff, num_rolls)
    #return 6  # Replace this statement
    # END PROBLEM 12
